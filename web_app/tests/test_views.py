...
class EndpointTests(TestCase, CommonSetup):
    ...
    def test_current_busyness(self):
        """This is a unit test case for the 'api/current-busyness/' endpoint. It retrieves the URL using the
        reverse() function based on the url pattern name (see urls.py). Tests that endpoint returns the expected
        data with the required keys.
        """
...
def populateTestBusyness():
    """This function populates the test database Results table with generated busyness data, required to test the
    functioning of te api/current-busyness endpoint
    """
